...
```json
{
  ...
  "amount": { "value": 100, "editable": true },
...
```
C0702259108;100;Bröllopsgåva Cajsa & Filip;6   # Christian (amount+message editable)
C0703929670;100;Bröllopsgåva Cajsa & Filip;6   # Elin (amount+message editable)
```
